...
# DELIBERADAMENTE uma configuracao invalida (PSEL_BITS=1, ver
# tb/psel_dueling_guard_neg_tb.v) e o CRITERIO DE SUCESSO e a propria
# elaboracao FALHAR com erro fatal -- pelo guard explicito de
# rtl/psel_dueling.v (instancia de modulo-guard proposital inexistente
...
# sim/run_repl_srrip_guard_neg.do / sim/run_repl_brrip_guard_neg.do):
#   1) exit code do PROCESSO vsim: quando a elaboracao falha dentro do -do,
#      o `vsim -c -do sim/run_psel_dueling_guard_neg.do` inteiro termina com
#      exit code != 0. Rodar:
#        vsim -c -do sim/run_psel_dueling_guard_neg.do ; echo "exit=$?"
...
#      psel_dueling.v, nao no negativo) -- ver tb/psel_dueling_guard_neg_tb.v:
...
#   vsim -c -do sim/run_psel_dueling_guard_neg.do ; echo "exit code: $?"
# ou, dentro do ModelSim GUI (com cwd = /home/miguel/verilog):
#   do sim/run_psel_dueling_guard_neg.do
#
# NAO faz parte do fluxo normal de simulacao -- run_psel_dueling.do (o
# script do dia a dia) NUNCA compila tb/psel_dueling_guard_neg_tb.v,
# exatamente para nao misturar um teste que deve falhar com a suite normal
# que deve passar. Este script tambem NUNCA e chamado por
# run_psel_dueling.do.
...
vsim -c work.psel_dueling_guard_neg_tb
